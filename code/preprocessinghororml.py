...
def preprocess_and_combine_all(input_folder, output_filepath):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".csv"):
            ...
            # --- ambil maksimal 300 review saja ---
            df = df.head(300)
            ...
            drop_cols = ["helpful", "total", "date", "title", "review", "genre2", "genre3", "username", "timestamp", "userId"]
            ...
            print(f"✔ Selesai memproses: {filename} | Data diambil: {len(df)}")
...
# --- jalankan ---
output_path = os.path.join("output_horor_film_clean_ml", "all_movies_combined.csv")
preprocess_and_combine_all("output_horor_film", output_path)
